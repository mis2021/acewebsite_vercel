...
export default function PagehaderLayoutv2(props) {
  return (
    <>
      ...
      <div
        class="container xl:max-w-6xl lg:max-w-5xl my-12  mx-auto"
      ...
      >
        ...
        {/* <section class="mb-20"> */}
          <div
            ...
            style={{ height: "60vh" }}
          >
            <div class=" overflow-hidden w-4/6 -right-40  absolute top-0 h-full md:block hidden">
            ...
            <div class="container " style={{paddingLeft: '8%', paddingTop: '5%'}}>
